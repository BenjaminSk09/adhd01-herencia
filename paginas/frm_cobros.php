        ...
        <div class="row justify-content-center">
            <div class="col col-4">
                ...
                <form action="../objetos/objeto_cobros.php" method="post">
                    ...
                    <div class="mb-3">
                        <label for="txtComisionCobro" class="form-label">Comision de cobro</label>
                        <input type="number" id="txtComisionCobro" name="txtComisionCobro" class="form-control"
                            placeholder="Ingrese su Comision">
                    </div>
                    <div class="mb-3">
